...
const allTravelServices = [
  ...
  { id: 'cpl03', name: 'সাজেক ভ্যালি মেঘের রাজ্য', price: 6500, thumbnail: inaniTamil, images: [inaniTamil, inaniImage2, inaniImage3, inaniImage4], rating: 4.9, location: 'সাজেক, রাঙ্গামাটি', category: 'Couple & Friends Escape', description: 'মেঘের উপরে বসবাসের এক অসাধারণ অভিজ্ঞতা অর্জন করুন।', features: ["রাউন্ড ট্রিপ ট্রান্সপোর্ট (চান্দের গাড়ি)", "ইকো-ফ্রেন্ডলি কটেজে থাকা", "প্রতিদিনের তিন বেলা খাবার", "স্থানীয় দর্শনীয় স্থান ভ্রমণ"] },
  { id: 'cpl04', name: 'টাঙ্গুয়ার হাওর ভ্রমণ', price: 5500, thumbnail: inaniTamil, images: [inaniTamil, inaniImage2, inaniImage3, inaniImage4], rating: 4.7, location: 'সুনামগঞ্জ, বাংলাদেশ', category: 'Couple & Friends Escape', description: 'বাংলাদেশের দ্বিতীয় বৃহত্তম মিঠাপানির জলাভূমিতে নৌকায় রাত্রিযাপন।', features: ["হাউসবোটে থাকার ব্যবস্থা", "সকল খাবার (স্থানীয় মেনু)", "ওয়াচ টাওয়ার ও ছোট ছোট গ্রাম ভ্রমণ", "নিরাপত্তা সরঞ্জাম"] },
  ...
  { id: 'exp02', name: 'সুন্দরবন ম্যানগ্রোভ সাফারি', price: 12500, thumbnail: inaniTamil, images: [inaniTamil, inaniImage2, inaniImage3, inaniImage4], rating: 4.8, location: 'সুন্দরবন, খুলনা', category: 'Explorer’s Special', description: 'বিশ্বের বৃহত্তম ম্যানগ্রোভ বনে একটি রোমাঞ্চকর নৌকা সাফারি।', features: ["৩ দিন ২ রাত ক্রুজ জাহাজে থাকা", "সকল খাবার", "বন বিভাগের অনুমতি ও ফি", "সশস্ত্র বন প্রহরী"] },
  ...
  // Family & Group Trips
  { id: 'fam01', name: 'ঐতিহাসিক ঢাকা সিটি ট্যুর', price: 3500, thumbnail: inaniTamil, images: [inaniTamil, inaniImage2, inaniImage3, inaniImage4], rating: 4.6, location: 'ঢাকা, বাংলাদেশ', category: 'Family & Group Trips', description: 'পুরান ঢাকার সমৃদ্ধ ইতিহাস ঘুরে দেখুন।', features: ["শীতাতপ নিয়ন্ত্রিত প্রাইভেট গাড়ি", "ইংরেজিভাষী গাইড", "সকল প্রবেশ টিকিট", "ঐতিহ্যবাহী পুরান ঢাকার খাবার"] },
  { id: 'fam02', name: 'শ্রীমঙ্গল চা বাগান ভ্রমণ', price: 4800, thumbnail: inaniTamil, images: [inaniTamil, inaniImage2, inaniImage3, inaniImage4], rating: 4.8, location: 'শ্রীমঙ্গল, সিলেট', category: 'Family & Group Trips', description: 'বাংলাদেশের চায়ের রাজধানীতে একটি শান্তিময় ভ্রমণ।', features: ["লাক্সারি রিসোর্টে থাকা", "চা বাগানে ভ্রমণ ও চা-পান", "লাউয়াছড়া জাতীয় উদ্যান ভ্রমণ", "সকালের নাস্তা"] },
  { id: 'fam03', name: 'বগা লেক ও কেওক্রাডং', price: 8500, thumbnail: 'https://images.unsplash.com/photo-1551632811-561732d1e306?q=80&w=800', images: ['https://images.unsplash.com/photo-1551632811-561732d1e306?q=80&w=800'], rating: 4.7, location: 'বান্দরবান, বাংলাদেশ', category: 'Family & Group Trips', description: 'পাহাড়ের চূড়ায় অবস্থিত বগা লেকে ক্যাম্পিং এবং কেওক্রাডং চূড়া জয়।', features: ["চান্দের গাড়ি", "ক্যাম্পিং সরঞ্জাম", "সকল খাবার", "অভিজ্ঞ গাইড"] },
