        ...
        <div className="py-20 bg-white">
            <div className="container mx-auto px-4">
                ...
                >
                    ...
                    <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-600">আমাদের সেবায় সন্তুষ্ট ভ্রমণকারীদের অভিজ্ঞতাগুলো দেখুন।</p>
                </motion.div>
                <Swiper
                    effect={'cards'}
                    grabCursor={true}
                ...
                >
                    {testimonials.map((item, index) => (
                        <SwiperSlide key={index} className="bg-slate-100 rounded-2xl shadow-xl flex flex-col justify-between p-8">
                            <Quote className="absolute top-6 left-6 text-green-200" size={40}/>
                            <p className="text-gray-600 italic mt-10">"{item.quote}"</p>
