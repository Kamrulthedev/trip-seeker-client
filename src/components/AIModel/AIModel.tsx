...
const AIModal = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
    ...
    const getAIResponse = (userText: string) => {
        ...
        // ওয়েবসাইট সম্পর্কিত
        else if (text.includes("ওয়েবসাইট") || text.includes("আপনার ওয়েবসাইট") || text.includes("কে তৈরি করেছে") || text.includes("website")) {
        ...
        // সার্ভিসেস
            ...
            return `আমাদের সার্ভিসের মধ্যে রয়েছে ভ্রমণ গাইড, হোটেল বুকিং ইনফো, যাতায়াত নির্দেশনা, এবং ট্রাভেল টিপস। বিস্তারিত জানতে ভিজিট করুন: 👉 [আমাদের সার্ভিসেস](https://trip-seeker-bd.vercel.app/services)`;
        }
        ...
        // লোকেশন সম্পর্কিত (গুগল সার্চ লিঙ্ক সহ)
            ...
            return `আপনি "${userText}" সম্পর্কে আরও জানতে চাইলে এখানে ক্লিক করুন: 🔎 [গুগল সার্চ করুন](https://www.google.com/search?q=${encodeURIComponent(userText)})`;
        }
