...
const Logo = () => {
    return (
        <div>
            <Link className="cursor-pointer flex items-center lg:p-2 p-4 gap-2 lg:-ml-10 bg-white rounded-2xl
                ...
                />
                <h1 className="lg:text-4xl md:text-4xl text-2xl font-extrabold tracking-wider
